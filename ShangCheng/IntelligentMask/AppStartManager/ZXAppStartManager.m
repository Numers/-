...
//    [[UITabBar appearance] setSelectedImageTintColor:[UIColor colorWithRed:0.722 green:0.914 blue:0.525 alpha:1.000]];
    ...
    [[UITabBar appearance] setBackgroundImage:[self imageWithColor:[UIColor colorWithRed:0.000 green:0.722 blue:0.933 alpha:1.000]]];
...
{
    if (scHomeVC) {
        [[NSNotificationCenter defaultCenter] removeObserver:scHomeVC];
    }
    [[BluetoothManager defaultManager] stopBluetoothDevice];
