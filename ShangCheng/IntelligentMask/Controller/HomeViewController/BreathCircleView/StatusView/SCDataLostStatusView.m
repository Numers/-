...
@implementation SCDataLostStatusView
...
{
    if ([self.delegate respondsToSelector:@selector(resetDeviceConnect)]) {
        [self.delegate resetDeviceConnect];
    }
}
